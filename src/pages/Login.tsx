  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div className="absolute -top-24 -left-24 w-96 h-96 rounded-full bg-orange-100/50 blur-3xl"></div>
      ...
      >
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 tracking-tight">
          Oficina <span className="text-orange-500">Pro</span>
        </h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              <button
                ...
                disabled={isLoading}
                className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-bold text-gray-900 bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 disabled:opacity-70 transition-all duration-200"
              >
                {isLoading ? (
